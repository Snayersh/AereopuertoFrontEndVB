...
Public Class ReporteVuelosGral
    ...
    Private Sub GenerarReporte()
        Dim db As New ConexionDBReplica() ' ⚠️ OBLIGATORIO: CONEXIÓN A LA RÉPLICA
        Try
            Using conn As OracleConnection = db.ObtenerConexion()
                Using cmd As New OracleCommand("SP_REPORTE_VUELOS_ESTADO", conn)
                    ...
                    Using da As New OracleDataAdapter(cmd)
                        ...
                        For i As Integer = 0 To dt.Rows.Count - 1
                            ...
                            jsonLabels.Append($"""{row("estado_vuelo")}""")
                            jsonDatos.Append(row("total_vuelos").ToString())
