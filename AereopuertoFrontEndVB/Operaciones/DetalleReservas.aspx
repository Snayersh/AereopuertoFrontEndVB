<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DetalleReservas.aspx.vb" Inherits="AereopuertoFrontEndVB.DetalleReservas" %>
<!DOCTYPE html>
<html lang="es">
<head runat="server">
    <meta charset="utf-8" />
    <title>Gestión de Reservas y Promociones - La Aurora</title>
...
<body>
    <form id="form1" runat="server">
        <div class="top-bar d-flex justify-content-between align-items-center mb-5">
            <h4 class="m-0 fw-bold">🎟️ Centro de Atención: Reservas y Descuentos</h4>
        ...
        <div class="container" style="max-width: 1000px;">
            ...
            <div class="aur-card">
                <h5 class="section-title">1. Seleccionar Reserva (Padre)</h5>
                <div class="row align-items-end">
                    <div class="col-md-9 mb-3 mb-md-0">
                        <label class="form-label small fw-bold text-secondary">Localizador / Código de Reserva *</label>
                        <asp:DropDownList ID="ddlReservas" runat="server" CssClass="form-select bg-light border-secondary"></asp:DropDownList>
                    </div>
                    <div class="col-md-3">
                        <asp:Button ID="btnVerDetalles" runat="server" Text="Cargar Reserva 🔍" CssClass="btn btn-success w-100 fw-bold shadow-sm" />
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="aur-card" style="border-top-color: #2e7d32;">
                            <h5 class="section-title" style="color: #2e7d32;">Aplicar Descuento</h5>
                            <div class="mb-4">
                                <label class="form-label small fw-bold text-secondary">Campaña / Promoción *</label>
                                <asp:DropDownList ID="ddlPromos" runat="server" CssClass="form-select"></asp:DropDownList>
                            </div>
                            <asp:Button ID="btnGuardarPromo" runat="server" Text="Vincular Promoción 🏷️" CssClass="btn btn-custom w-100 py-3 shadow-sm" />
                        </div>
                    </div>

                    <div class="col-md-8">
                        <div class="aur-card" style="border-top-color: #424242;">
                            <h5 class="section-title" style="color: #424242;">Promociones Aplicadas a esta Reserva</h5>
                            <div class="table-responsive">
                                <table class="table table-hover align-middle">
                                    <thead class="table-light">
                                        <tr>
                                            <th>CAMPAÑA APLICADA</th>
                                        ...
                                        <asp:Repeater ID="rptPromos" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <asp:Label ID="lblBadgeDescuento" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                ...
                                <asp:Panel ID="pnlVacio" runat="server" Visible="false" CssClass="text-center py-4">
                                    <p class="text-muted fw-bold">Esta reserva no tiene ninguna promoción o descuento aplicado.</p>
                                </asp:Panel>
                            </div>
                        </div>
                    </div>
