...
<head runat="server">
    ...
    <style>
        ...
        .boarding-pass { max-width: 800px; margin: 0 auto; background: white; border-radius: 15px; box-shadow: 0 15px 35px rgba(0,0,0,0.1); display: flex; overflow: hidden; position: relative; }
        ...
        @media print {
            ...
            .boarding-pass { box-shadow: none; border: 1px solid #ddd; margin-top: 20px; }
        }
    </style>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="text-center mb-4 no-print">
            ...
            <p class="mt-2 text-muted">Asegúrate de llevar este documento el día de tu vuelo.</p>
        </div>
        ...
        <asp:Panel ID="pnlPase" runat="server" CssClass="boarding-pass">
            <div class="bp-left">
                <div class="header">
                ...
                <div class="row">
                    <div class="col-8">
                        ...
                        <div class="val text-uppercase"><asp:Label ID="lblPasajero" runat="server"></asp:Label></div>
                    </div>
                    <div class="col-4">
                        <div class="lbl">Vuelo</div>
                        <div class="val text-primary"><asp:Label ID="lblVuelo" runat="server"></asp:Label></div>
                    </div>
                </div>
                ...
                <div class="row align-items-center my-3">
                    <div class="col-5 text-center">
                        ...
                        <div class="city-name"><asp:Label ID="lblOrigenCiudad" runat="server"></asp:Label></div>
                    </div>
                    ...
                    <div class="col-5 text-center">
                        ...
                        <div class="city-name"><asp:Label ID="lblDestinoCiudad" runat="server"></asp:Label></div>
                    </div>
                </div>
                ...
                <div class="row mt-4 border-top pt-3">
                    <div class="col-3">
                        ...
                        <div class="val fs-6"><asp:Label ID="lblFecha" runat="server"></asp:Label></div>
                    </div>
                    <div class="col-3">
                        <div class="lbl">Hora de Salida</div>
                        <div class="val fs-6"><asp:Label ID="lblHora" runat="server"></asp:Label></div>
                    </div>
                    <div class="col-3">
                        <div class="lbl">Clase</div>
                        <div class="val fs-6 text-primary"><asp:Label ID="lblClase" runat="server"></asp:Label></div>
                    </div>
                    <div class="col-3">
                        <div class="lbl">Asiento</div>
                        <div class="val fs-3 text-danger"><asp:Label ID="lblAsiento" runat="server"></asp:Label></div>
                    </div>
                </div>
            </div>
            ...
            <div class="bp-right border-start">
                ...
                <div class="w-100 mb-2">
                    ...
                    <div class="val fs-4"><asp:Label ID="lblCodigoRecorte" runat="server"></asp:Label></div>
                </div>
                
                <div class="w-100 mb-2">
                    <div class="lbl">Asiento</div>
                    <div class="val fs-3 text-danger"><asp:Label ID="lblAsientoRecorte" runat="server"></asp:Label></div>
                </div>
